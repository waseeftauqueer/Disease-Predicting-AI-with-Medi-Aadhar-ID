...
<div class="row1">
  <div class="column1">
    <div class="card1">
	  ...
	  <img src="medicine.png" alt="Nature" width="30%" height="200px">
   <br><br><button type="submit" name="school" class="registerbtn">To Add Medical Prescriptions</button>
 
      <p>To Add the Patients Medical Prescriptions</p>
    <br><br> </div>
  </div>
  ...
  <div class="column1">
    <div class="card1">
      <h3>Patient Medical History</h3>
	    <img src="mhis.png" alt="Nature" width="30%" height="200px">
